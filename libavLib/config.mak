...
LIBAV_CONFIGURATION=--target-os=darwin --enable-cross-compile --extra-libs=-lgcc --prefix=./myIOS --arch=arm --cpu=cortex-a8 --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS6.1.sdk --enable-version3 --enable-gpl --enable-shared --disable-everything --disable-ffmpeg --disable-avplay --disable-avprobe --disable-avdevice --disable-decoders --disable-encoders --enable-muxers --enable-demuxers --disable-parsers --enable-encoder=mpeg4 --disable-yasm --disable-doc --disable-avconv --disable-ffmpeg --disable-avserver --disable-avfilter --enable-swscale --disable-devices --disable-protocols --enable-protocol=file --disable-network --cc=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/usr/bin/gcc --cross-prefix=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/usr/bin/ --nm=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/usr/bin/nm --extra-cflags='-arch armv7s' --disable-asm --extra-ldflags='-arch armv7s -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS6.1.sdk '
prefix=./myIOS
...
CFLAGS= -arch armv7s -mcpu=cortex-a8 -std=c99 -fomit-frame-pointer -fPIC -marm -g -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wundef -Wmissing-prototypes -Wstrict-prototypes -O3 -fno-math-errno -mllvm -stack-alignment=16
ASFLAGS= -arch armv7s -mcpu=cortex-a8 -fPIC -g
AS_O=-o $@
CC_O=-o $@
DLLTOOL=
LDFLAGS= -arch armv7s -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS6.1.sdk --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS6.1.sdk -Wl,-dynamic,-search_paths_first
...
ACODEC_TESTS=adpcm_adx aref g722 pcm_alaw pcm_f32be pcm_f32le pcm_f64be pcm_f64le pcm_mulaw pcm_s16be pcm_s16le pcm_s24be pcm_s24daud pcm_s24le pcm_s32be pcm_s32le pcm_s8 pcm_u8 
VCODEC_TESTS=cljr dnxhd_720p_10bit qtrle v210 vref 
LAVF_TESTS=aiff alaw asf au avi dv_fmt ffm flv_fmt gxf mkv mmf mov mpg mulaw mxf nut ogg pixfmt rm swf ts voc voc_s16 wav yuv4mpeg 
